...
embed the pinned PostgreSQL-derived parser and pgTAP artifact, and avoid runtime
plug-ins and dynamically linked database client libraries.
...
- PostgreSQL parser and pgTAP upgrades are deliberate release work.
